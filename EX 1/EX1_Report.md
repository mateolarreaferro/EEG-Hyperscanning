...
![FRN Interaction Plot](output/FRN_interaction_plot.png)
...
|:---:|:---:|:---:|:---:|
| ![](output/FRN-Human-Same-Self.png) | ![](output/FRN-Human-Same-Other.png) | ![](output/FRN-Human-Diff-Self.png) | ![](output/FRN-Human-Diff-Other.png) |

| Comp-Same-Self | Comp-Same-Other | Comp-Diff-Self | Comp-Diff-Other |
|:---:|:---:|:---:|:---:|
| ![](output/FRN-Comp-Same-Self.png) | ![](output/FRN-Comp-Same-Other.png) | ![](output/FRN-Comp-Diff-Self.png) | ![](output/FRN-Comp-Diff-Other.png) |
...
![Alpha ERD Interaction Plot](output/AlphaERD_interaction_plot.png)
...
![Alpha Topomap - Leader Human Same](output/Alpha-leader-human-same.png)
![Alpha Topomap - Leader Human Diff](output/Alpha-leader-human-diff.png)
![Alpha Topomap - Leader Comp Same](output/Alpha-leader-comp-same.png)
![Alpha Topomap - Leader Comp Diff](output/Alpha-leader-comp-diff.png)

**Figure 5.** Topographic maps of alpha ERD (%) for Follower conditions, averaged within the Follower time window (−0.249 to 0.375 s).

![Alpha Topomap - Follower Human Same](output/Alpha-follower-human-same.png)
![Alpha Topomap - Follower Human Diff](output/Alpha-follower-human-diff.png)
![Alpha Topomap - Follower Comp Same](output/Alpha-follower-comp-same.png)
![Alpha Topomap - Follower Comp Diff](output/Alpha-follower-comp-diff.png)
...
To improve these results, including all available pairs (rather than restricting to the 5 cleanest) would increase sample size. Individual alpha frequency (IAF) estimation could be used to tailor the frequency band to each participant, potentially reducing variability. More sophisticated artifact rejection methods and analysis of time-frequency dynamics (rather than single time-window averages) could also improve sensitivity to the experimental effects.
